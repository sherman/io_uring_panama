...
public class __kernel_timespec {
    ...
    public static MemoryLayout $LAYOUT() {
        return __kernel_timespec.$struct$LAYOUT;
    }
    ...
    public static VarHandle tv_sec$VH() {
        return __kernel_timespec.tv_sec$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long tv_sec$get(MemorySegment seg) {
        return (long)__kernel_timespec.tv_sec$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void tv_sec$set(MemorySegment seg, long x) {
        __kernel_timespec.tv_sec$VH.set(seg, x);
    }
    public static long tv_sec$get(MemorySegment seg, long index) {
        return (long)__kernel_timespec.tv_sec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void tv_sec$set(MemorySegment seg, long index, long x) {
        __kernel_timespec.tv_sec$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle tv_nsec$VH() {
        return __kernel_timespec.tv_nsec$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long tv_nsec$get(MemorySegment seg) {
        return (long)__kernel_timespec.tv_nsec$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void tv_nsec$set(MemorySegment seg, long x) {
        __kernel_timespec.tv_nsec$VH.set(seg, x);
    }
    public static long tv_nsec$get(MemorySegment seg, long index) {
        return (long)__kernel_timespec.tv_nsec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void tv_nsec$set(MemorySegment seg, long index, long x) {
        __kernel_timespec.tv_nsec$VH.set(seg.asSlice(index*sizeof()), x);
    }
